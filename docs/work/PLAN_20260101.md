...
- [ ] **BackgroundExpander** - `background` → 8 longhands
...
- [ ] `flex: 1` expands to proper longhands
- [ ] `flex-flow: row wrap` expands correctly
- [ ] `gap: 10px 20px` expands to row-gap/column-gap
- [ ] All existing tests still pass
- [ ] New expanders have unit tests
